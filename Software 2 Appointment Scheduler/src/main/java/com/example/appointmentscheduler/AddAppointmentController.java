...
public class AddAppointmentController implements Initializable {
    ...
    public void addAppointmentButton(ActionEvent actionEvent) throws IOException, SQLException {
        String t = null;
        String d = null;
        String l = null;
        String type = null;
        ...
        if (alert.showAndWait().get()== ButtonType.OK) {
            ...
            try {
                int startHourInt = Integer.parseInt(startHour.getValue());
                int endHourInt = Integer.parseInt(endHour.getValue());
                int endMinInt = Integer.parseInt(endMinute.getValue());
                int startMinInt = Integer.parseInt(startMinute.getValue());
                ...
                end = Helper.convertLocalToUTC(endD);
                endBool = Helper.isInBusinessHours(endD);
                startBool = Helper.isInBusinessHours(startd);
                overlapBool = DatabaseAppointmentQuery.checkForOverlappingAppointments(cust,s,end);
                System.out.println(overlapBool);
            ...
            if ((endBool) && (startBool) && (!overlapBool))  {
                if (DatabaseAppointmentQuery.insert(t,d,l,type,s,end,cust,u,cont,c) ==1){
                    ...
                    Helper.alertUser("Something went wrong!", "Check your values and try again");
                }
            }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        valueFactoryEndHour.setValue("12");
